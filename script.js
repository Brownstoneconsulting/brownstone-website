document.addEventListener('DOMContentLoaded', () => {
    ...
    const mobileToggle = document.getElementById('mobile-menu-btn') || document.getElementById('mobile-toggle') || document.getElementById('mobileMenuBtn') || document.querySelector('[data-drawer-target="mobile-drawer"]');
